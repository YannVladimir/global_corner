  ...
  ?>	
	...
	<section>
		<div class="container">
            ...
            <img class='sizingimagesmax' src='/eshopper/assets/images/posts/{$row['photo3']}' alt=''/></div>
            ...
            <img class='sizingimagesmax' src='/eshopper/assets/images/posts/{$row['photo4']}' alt=''/></div>
