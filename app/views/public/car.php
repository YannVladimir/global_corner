        ...
        <div class="col-sm-6 padding-right">
            <div class="contact-form align-center">
              ...
              <div class="status alert alert-success" style="display: none"></div>
                          ...
                          <div class="btn-group pull-right">
                            <div class="btn-group">
                               ...
                               <ul class="dropdown-menu">
                                  ...
                                  <li><a href="upload_mobiles">mobiles</a></li>
                  ...
                  <br><br><br>
                  <div id="electronics">
                    <form action="uploadingprocess" id="validation" class="upload-form row" name="upload-form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-12">
                            <div> 
                                  <input type="file" name="main" id="inp" class="hide" required="required"/>
