            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-6">
                        <div class="panel panel-red">
                            ...
                            <a href="delete-ssubcategory.php">
                                <div class="panel-footer">
                                    <span class="pull-left">Delete</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                       ...
                       <form action="newssubcategory.php" method="post" enctype="multipart/form-data">
                             <label>Select Ref1 category : </label>
                           <select name="ref">
                             ...
                             <?php 
                              ...
                              ?>
                           </select><br><label>Select Ref2 category : </label>
                           <select name="ref1">
                             <option>Select category</option>
                             <?php 
                                $query = "SELECT * FROM service_categories";
                           ...
                           <label>Select Ref3 category : </label>
                           <select name="ref2">
                             <option>Select category</option>
                             <?php 
                                $query = "SELECT * FROM service_categories";
                           ...
                           <label>Select Ref4 category : </label>
                           <select name="ref3">
                             <option>Select category</option>
                             <?php 
                                $query = "SELECT * FROM service_categories";
